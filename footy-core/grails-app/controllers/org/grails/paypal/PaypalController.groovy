...
REQUEST INFO: ${params}
		...
		REQUEST INFO: ${params} """
                        ...
                        markPaid(payment, params, Payment.COMPLETE)
					} else if (status == 'Pending') {
                        markPaid(payment, params, Payment.PENDING)
					} else if (status == 'Failed') {
                        markPaid(payment, params, Payment.FAILED)
					}
				}
    ...
    void markPaid(payment, params, status) {
		...
		log.info "Verified payment ${payment} as ${status}"
    }
