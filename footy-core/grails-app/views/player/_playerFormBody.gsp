<%@ page import="org.davisononline.footy.core.*" %>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value date">
                                <g:datePicker name="dateOfBirth" precision="day" noSelection="[null:'-select-']" years="${(now.year-55+1900)..(now.year-2+1900)}" value="${playerInstance?.dateOfBirth}"  />
                        ...
                        <tr class="prop">
                            ...
                            <td  class="value">
                                <g:select name="sibling.id" from="${siblings}" noSelection="[null:'-- Not applicable --']" optionKey="id" value="${playerInstance?.sibling?.id}"/>
