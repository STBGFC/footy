        ...
        <div class="list">
            ...
            <div class="nav">
                ...
                <table class="list">
                    <thead>
                        <tr>
                            <th>${message(code: 'org.grails.paypal.payment.transactionId.label', default: 'Club Transaction Id')}</th>
                            <th>${message(code: 'org.grails.paypal.payment.status.label', default: 'Status')}</th>
                            <th>${message(code: 'org.grails.paypal.payment.paypalTransactionId.label', default: 'PayPal Transaction Id')}</th>
                    ...
                    <g:each in="${paymentList}" status="i" var="payment">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            <td><g:link action="show" id="${payment.transactionId}">${payment?.transactionId}</g:link></td>
                            <td>
