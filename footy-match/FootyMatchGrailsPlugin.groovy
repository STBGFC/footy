class FootyMatchGrailsPlugin {
    ...
    def title = "Fixtures and results module for the league management system"
    def description = '''\\
Provides domain classes, controllers and views for creating fixtures, results
and match reports.
'''

    // URL to the plugin's documentation
    def documentation = "http://grails.org/plugin/footy-match"
